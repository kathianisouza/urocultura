...
public class LinearHT {
    ...
    // -------------- public methods ------------------------
    public LinearHT(ImageProcessor ip, HoughCircles hc, int nAng, int nRad) {
        this.ip = ip;
        this.hc = hc;
    ...
    /*
     * Find and return the parameters of the n strongest lines (with max. pixel
     * counts)
     */
            ...
            for (int ai = 0; ai < nAng; ai++) {
                ...
                if (hcount >= minPts) {
                    ...
                    if (hcount > last.count) {
                        ...
                        last.count = hcount;
                        Arrays.sort(linArr); // this may be more efficient with
                        // insert sort
                    }
                }
            }
    ...
    private void findLocalMaxima() {
        ...
        for (int ai = 0; ai < nAng; ai++) {
            ...
            for (int ri = 1; ri < nRad - 1; ri++) {
                ...
                boolean ismax = ha > houghArray[a1][ri - 1]
                        && ha > houghArray[a1][ri]
    ...
    // returns real radius for radius index ri (with respect to image center
    // <uc,vc>)
    ...
    public class HoughLine implements Comparable<HoughLine> {
        ...
        public Line2D.Double makeLine2D() {
            //JOptionPane.showMessageDialog(null, "Angulo: " + angle);
            //JOptionPane.showMessageDialog(null, hc.getXC() + hc.getRadius());
